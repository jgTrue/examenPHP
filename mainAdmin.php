...
<body>
                ...
                <table class="table table-dark table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="p-3">Nombre de usuario</th>
    ...
    <?php } else { ?>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
            <div class="container-fluid">
                <a class="navbar-brand fs-3 my-2" href="./mainAdmin.php"><i class="bi bi-fast-forward-btn mx-3 fs-2 text-danger"></i>Videoclub</a>
            </div>
        </nav>
